                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6">
                            <div class="img-block img2">
                                <div class="img-holder" data-animation-in="bounceInUp"
                                    data-animation-out="animate-out fadeOutRight">
                                    <img style="height:500px;" src="assets/images/product1.png" alt="" class="img-responsive">
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-6">
...
<section style="margin-top: -100px; " class="fastive-season new-block">
    ...
    <div class="fixed-bg parallax" style="background: url('assets/images/slider-bgs1.jpg');"></div>
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <div class="title">
